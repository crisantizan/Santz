...
class Santz {
           ...
           */
            ...
            */
            if (!changeVisibility && !destroy && firstColumnState && strictMode) {
                ...
                console.log(changeVisibility, destroy, firstColumnState, strictMode);
            }
        }
    ...
    limit(startOrAmount, numRows = null) {
        ...
        if (numRows === null) {
            query += `LIMIT ${startOrAmount}`;
        } else {
            query += `LIMIT ${startOrAmount}, ${numRows}`;
        }
        return this;
    }
    /**
    ...
    exec () {
        const execution = new Promise( (resolve, reject) => {
            ...
            */
            ...
            /* Mostrar la SQL en pantalla siempre y cuando no haya un error */
            let selfShowQuery = true;
            ...
            if (showQuery) {
                ...
                /* Mostrar la sentencia SQL ejecutada */
                if (selfShowQuery) {
